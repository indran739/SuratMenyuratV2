        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <i class='bx bxs-message-square-edit menu-icon'></i>
                    <span class="menu-title">Pengajuan Surat</span>
                    <i class='menu-arrow menu-icon'></i>
                    </a>
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="/surat_ijin_kp">Surat Ijin KP</a></li>
                            <li class="nav-item"> <a class="nav-link" href="/surat_tugas">Surat Tugas</a></li>
                            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Surat Berita Acara</a></li>
                            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Surat Keterangan</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
