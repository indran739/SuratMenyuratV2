        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-dark">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a class="text-dark" href="#">Pengajuan Surat</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content" href="/form_stugas">
              <a href="/form_stugas">
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-12" href="">
            <div class="info-box">
